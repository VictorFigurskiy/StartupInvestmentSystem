...
<div class="container container-top">
    ...
    <div class="indexSearchMainBlock">
        <div class="indexSearchBlock1" >
            <form action="${contextPath}/search/byName" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" lang="ru-UA">
        ...
        <div class="indexSearchBlock2">
            <form action="${contextPath}/search/byCountry" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" lang="ru-UA">
